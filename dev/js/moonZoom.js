...
moonManTL.fromTo("#left-eye",{alpha:0, scale:0},{display: "block", alpha: 1, duration:0.5, scale:1})
        .fromTo("#right-eye",{alpha:0, scale:0},{display: "block", alpha: 1, duration:0.5, scale:1})
        .to("#moon",{scale:5, duration:1, y:"-=800"})
        .fromTo("#mouth",{alpha:0, scale:0},{display: "block", alpha: 1, duration:0.5, scale:1}, "-=.75")
        .fromTo("#right-arm",{alpha:0, scale:0, rotate:90},{display: "block", alpha: 1, duration:0.5, scale:1, rotate:0}, "limbs")
        .fromTo("#left-arm",{alpha:0, scale:0, rotate:-90},{display: "block", alpha: 1, duration:0.5, scale:1, rotate:0}, "limbs")
        .fromTo(".moon-legs",{alpha:0, scale:0, rotate:45},{display: "block", alpha: 1, duration:0.5, scale:1, rotate:0}, "limbs")
        .to("#space-ship",{duration:5, rotate:75, x:"+=500", y:"-=250", scale:0}, "-=2")
        .fromTo("#cape",{alpha:0, scale:0, rotate:45},{display: "block", alpha: 1, duration:0.5, scale:1, rotate:0}, "-=3")
